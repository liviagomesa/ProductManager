...
const routes: Routes = [
  ...
  { path: 'produtos', component: ProductListComponent }, // Lista os produtos em uma tabela
  // (colunas para nome, preço e quantidade) com filtros e ordenação (MatSort), paginação (MatPaginator)
  // e opções de criar, editar e remover produtos (MatDialog para confirmar ações como exclusão)
  ...
  { path: 'produtos/:id', component: ProductDetailsComponent }, // Exibe os detalhes de um produto (usando Resolver e ActivatedRoute)
];
